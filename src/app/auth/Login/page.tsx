    ...
    return(
        <main className = "flex items-center justify-center py-12">
            {session ? (<section>
                ...
                <input value = {email} onChange = {(e) => setEmail(e.target.value)} className = "px-4 py-2 rounded-md border-2 w-full border-black" placeholder="Email"/>
                <input value = {password} onChange = {(e) => setPassword(e.target.value)} className = "px-4 py-2 rounded-md border-2 w-full border-black" placeholder = "Password"/>
